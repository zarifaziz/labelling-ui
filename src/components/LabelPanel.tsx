...
export function LabelPanel() {
  ...
  if (!selectedItem) {
    return (
      <aside className="h-full bg-white border-l border-gray-200 p-4 shadow-sm">
  ...
  return (
    <aside className="h-full bg-white border-l border-gray-200 flex flex-col shadow-sm">
      {/* Outcome Toggle */}
